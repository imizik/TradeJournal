...
| Metric | Amount | Notes |
| --- | --- | --- |
| Dashboard total_pnl | $2,257.92 | Closed + expired realized P&L only, matching /stats |
| All realized P&L including open trades | $2,360.83 | Adds realized P&L already locked in on still-open positions |
...
| Roth IRA 8267 | 3328 | 2025-07-10 to 2026-04-17 | 3 | $3,079.42 | $3,182.33 | $102.91 | 9 | $3,561.85 |
...
| DB fill rows in overlap | 3328 |
| CSV normalized fill keys | 2404 |
| DB normalized fill keys | 2404 |
| Exact-match keys | 2379 |
| Mismatch keys | 29 |
| Closed/expired P&L through CSV max date | $3,079.42 |
...
- `2025-09-26 CNC stock buy stock | material stock notional differences | csv qty=7.085163 db qty=7.085163 csv notional=249.964551 db notional=250.035402`
...
| Option close anomalies | 1 | $78.00 | These option closes are orphaned or over-sized, so the realized P&L is only partially represented |
| Total anomalies | 14 | - | Any anomaly weakens broker-vs-app reconciliation until the missing source fills are backfilled |
...
| 2025-10 | $0.00 | $688.06 | $688.06 |
| 2025-11 | $0.00 | $1,267.61 | $1,267.61 |
...
| 2026-04 | $-77.00 | $1,739.83 | $1,662.83 |
...
| Roth IRA 8267 | AMD | option | $909.00 | 48 |
